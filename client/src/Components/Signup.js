...
function mapDispatchToProps(dispatch){//writes to store state
        ...
        return (
          <div className="signup">
            <div className="signup__user">
              ...
              <button className="signup__button" onClick={()=>this.handleLogin()}>
            ...
            <div className="signup__nonuser">
              <p>
                ...
                continue as a <button className="signup__button" onClick={()=>this.handleGuest()}>guest</button>.
              </p>
            </div>
          </div>
        );
